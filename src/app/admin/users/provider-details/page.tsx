...
const tabs = ["General Information", "Documents Uploaded", "Badge(s)"] as const;
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="mt-1 flex items-center gap-1 text-sm text-gray-500">
            ...
            <span className="hover:text-[#1B2A4A]">Legal service provider</span>
            <ChevronRight size={14} />
            <span className="text-gray-700">Legal service provider Details</span>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex border-b border-gray-100 pb-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {practiceAreas.map((area) => (
                        <span
                          key={area}
                          className="rounded-full border border-blue-200 bg-blue-50 px-3 py-0.5 text-xs font-medium text-blue-700"
                        >
                          {area}
                        </span>
                      ))}
                  ...
                  {generalInfoExtra.map(({ label, value, isStatus }) => (
                    <div key={label} className="flex border-b border-gray-100 pb-3">
                      <p className="w-48 text-sm text-gray-500">{label}</p>
                      <p className={`text-sm font-semibold ${isStatus ? "text-amber-500" : "text-[#1B2A4A]"}`}>
                        {value}
                      </p>
                    </div>
                  ))}
